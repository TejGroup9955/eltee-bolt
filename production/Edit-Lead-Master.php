                ...
                <div class="row">
                    <div class="col-md-8">         
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-4" data-toggle="tooltip" data-placement="left" title="Please Enter Customer Name" >
                                    <label>Customer / Organization Name</label>
                                    <input type="text" placeholder="Enter Customer Name" name="client_name" onkeypress="return isAlpha(event)" value="<?php echo @$client_name1;?>" class="form-control required " required="" />
                                </div>
                                <div class="col-md-4 col-sm-12 col-xs-12" data-toggle="tooltip" data-placement="left" title="Please Enter Customer Business">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-4" data-toggle="tooltip" data-placement="left" title="Please Enter Customer Email">
                                            <label>Customer Email</label>
                                            <input type="text" name="client_email" placeholder="Enter Customer Email ID" value="<?php echo @$client_email1;?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" class="form-control no_space" />
                                        </div>
                                        <div class="col-md-4" data-toggle="tooltip" data-placement="left" title="Please Enter Customer Mobile">
                                            <label>Customer Mobile</label>
                                            <input type="text" id="client_mob" name="client_mob" placeholder="Enter Customer Mobile"  onkeypress="return isNumber(event)" value="<?php echo @$client_mob1;?>" class="form-control required "  required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col12" id="contact_person_new">
                                        ...
                                        <div class="col6">
                                            <label>Customer Mobile</label>
                                            <input type="text" id="contact_person_mobile" class="form-control Number" placeholder="Customer Mobile" />
                                        </div>
                                        <div class="col6">
                    ...
                    <div style="text-align: center;" class="col-md-12">
                        ...
                        <a href="Lead-Summary.php" class="btn btn-round btn-secondary"><i class="fa fa-chevron-left"></i>&nbsp; Back</a>
                        <br>
                        <br>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                   ...
                   if(response=="Updated")
                   {
                        ...
                        setTimeout(() => {
                           window.location.href="Lead-Summary.php";
                        }, 2000);
                   }
                    else
                   {
