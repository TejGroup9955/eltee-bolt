        ...
        <div class="card-body p-3">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type='hidden' class="form-control small-input" id="hiddenPOType" name="hiddenPOType" value="Direct PO">
            ...
            <div class="row mt-3" style="border:1px solid black;margin: 1px;border: 1px solid #8a8d93; padding: 5px;">
                <div class="col-md-3">
