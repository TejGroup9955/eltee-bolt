    ...
    <div class="card" >
        <div class="card-body">
            ...
            <div class="col-md-1" style="width: 5%;">
                <button class="btn btn-primary btn-round btn-sm"><i class="fa fa-search"></i></button>
            </div>
        </div>
    </div>
    <div class="card mt-3">
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <label>Enter client delete reason:</label>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        var dataTable = $('#employee-grid').DataTable( {
            ...
            buttons: [
                {
                    text: '<i class="fa fa-plus"></i> New Customer',
                    className: 'btn btn-primary btn-round btn-sm',
                    action: function () {
                        window.location.href = 'Lead-fresh-Visit.php';
                    }
                }
            ],
            ...
            "ajax":{
                ...
                data: {lead_summary:lead_summary,LeadType:"Lead"},
