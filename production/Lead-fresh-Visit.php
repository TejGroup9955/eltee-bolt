            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="col12 custom_header_panel custom_header_panel_back_1"><i class="fa fa-user"></i> Business Details</div><hr>
                        <div class="row">
                            <input type="hidden" name="LeadType" id="LeadType" value="Lead">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12" >
                                ...
                                <input type="text" name="kind_attention" id="kind_attention" placeholder="Enter Kind Attention" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-4">
                                <label>Office Address</label>
                                <textarea class="form-control" id="client_add" name="client_add" placeholder="Office Address" rows="4"><?php echo @$client_add;?></textarea>
                            </div>
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4" data-toggle="tooltip" data-placement="left" title="Please Enter Customer Mobile/Telephone">
                        ...
                        <div class="row mt-2">    
                            <div class="col-md-4">
                                ...
                                <select id="product_id" name="product_id[]" class="form-control js-example-basic-multiple required" multiple="multiple">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12" data-toggle="tooltip" data-placement="left" title="Please Enter Customer Requirement Details">
                                ...
                                <input type="text" class="form-control required " required name="client_req" placeholder="Customer Requirement Details " value="<?php echo @$client_req;?>" >
                            </div>
                            <div class="col-md-2 ">
                            ...
                            <div class="col-md-2" data-toggle="tooltip" data-placement="left" title="Please Select Customer Status">
