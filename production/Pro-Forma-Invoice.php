                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="account_id" id="account_id" class='form-control small-input form-select' required onchange="LoadClientDetails();loadClientCountry();">
                                ...
                                if($user_type_id!=1)
                                {
                                    $usercondition = " AND user_id = $user_id";
                                }   
                                $rstsales = mysqli_query($connect,"select client_id, client_name from client_master where client_status NOT IN('Raw','Delete','Not Interested') AND LeadType = 'Lead' AND branch_id = $branch_id $usercondition" );
                                                ...
                                                if(mysqli_num_rows($rstpro)>0)
                                                {
                                                    while($rwpro = mysqli_fetch_assoc($rstpro))
                                                    {
                                                        ...
                                                        echo "<tr>
                                                                ...
                                                                <td style='display:none;'>$no_of_bags</td>
...
<script>
	...
	$(document).ready(function(){
		$("#frmpaymentpo").submit(function(e){
            ...
            formData.append("Flag", "SaveProForma");
            ...
            $("#tblproductdetails tbody tr").each(function () {
                ...
                const rowData = {
                    ...
                    rateperton: row.find("td:eq(2)").text().trim(),
                    totalweight: row.find("td:eq(3)").text().trim(),
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(response=="Pro-Forma Invoice generated successfully")
                        {
                            Swal.fire({
                                title: 'Success',
                                text: "Pro-Forma Invoice Generated Successfully",
                                icon: 'success',
                            });
                            setTimeout(() => {
                        ...
                        else if(response=="Pro-Forma Invoice Updated successfully")
                        {
                            Swal.fire({
                                title: 'Success',
                                text: "Pro-Forma Invoice Updated Successfully",
                                icon: 'success',
                            });
                            setTimeout(() => {
                                window.location.href="pro-forma.php";
                        ...
                        else
                        {
                            Swal.fire({
                                title: 'OOps',
                                text: "Unable to generate Pro-Forma...",
                                icon: 'warning',
                            });
                        }
                    },
